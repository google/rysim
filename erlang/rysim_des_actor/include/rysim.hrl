...
%%% calls.
%%%
%%% <em>event_queue</em> is pid that is passed intoevent_queue calls.
%%%
%%% === record(model_config) ===
...
-record(agent_data, {label :: string(),
...
-type(ng_data() :: #ng_data{}).

-record(model_data, {agents :: gb_trees:tree(string(), pid()),
                     dirty_agents :: gb_trees:tree(string(), pid()),
                     ng_data :: #ng_data{},
                     event_queue :: pid()}).
...
-record(controller_data, {event_limit :: event_count(),
                          ...
                          results :: #sim_results{},
                          from :: string(),
                          dirty_agents_count :: non_neg_integer()}).
